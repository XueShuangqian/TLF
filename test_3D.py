...
import torch
from networks.net_factory_3d_vnet import net_factory_3d
...
parser.add_argument('--exp', type=str,
                    default='TSS_CL_hard_120', help='experiment_name')
...
def Inference(FLAGS):
    snapshot_path = "/home/xsq/xsq/TSS-CL/dwh-result/model_MTCL_50_50/{}/{}".format(FLAGS.exp, FLAGS.model)
    num_classes = 2
    test_save_path = "/home/xsq/xsq/TSS-CL/dwh-result/model_MTCL_50_50/{}/{}_Prediction".format(FLAGS.exp, FLAGS.model)
    ...
    net.eval()
    avg_metric, std = test_all_case1(net, base_dir=FLAGS.root_path, method=FLAGS.model, test_list="test.txt", num_classes=num_classes,
