...
from networks.Projectorvnet import VNet_MTPD, VNet_MTPD_voting, MTPD_dual_VNet, Dualstream_VNet, ProjectorVNet
...
def net_factory_3d(net_type="unet_3D", in_chns=1, class_num=2):
    ...
    elif net_type == "Projectorvnet":
        net = ProjectorVNet(n_channels=in_chns, n_classes=class_num,
                   normalization='batchnorm', has_dropout=True).cuda()
