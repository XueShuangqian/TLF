...
def enhence0(img_Dir):
    ...
    for case in img_path:  
        ...
        idx = os.path.basename(case).split('.')[0]
        f = h5py.File(
                '/home/xsq/xsq/data_myself/GLIA-DATA/prob-train/Tr_{}.h5'.format(idx), 'w')
...
def enhence(img_Dir, label_Dir):
    ...
    for case in img_path:  
        ...
        print("img shape", image.shape)
        f = h5py.File(
                '/home/xsq/xsq/data_myself/GLIA-DATA/prob-train/Tr_{}.h5'.format(str(idx)[:]), 'w')
...
def enhence1(img_Dir, label_Dir):
    img_path = sorted(glob.glob(img_Dir))
    for case in img_path:  
        print(case)
        img_itk = sitk.ReadImage(case)  # read img
        ...
        sitk.WriteImage(img_itk, '/home/xsq/xsq/data_myself/my data/zz/Tr_{}.nii.gz'.format(str(idx)[:]))
        #sitk.WriteImage(label_itk,
                            #'/home/xsq/xsq/data_myself/p-label-prob/Tr_{}.nii.gz'.format(str(idx)[:]))
    print("Converted val IRCAD volumes to ROI")

def cut(img_Dir, label_Dir):
    img_path = sorted(glob.glob(img_Dir))
    for case in img_path:  
        print(case)
        img_itk = sitk.ReadImage(case)  # read img
        ...
        label_itk.SetSpacing(spacing)
        #label_itk.SetSpacing((1.0, 1.0, 1.0))
        sitk.WriteImage(img_itk, '/home/xsq/xsq/data_myself/GLIA-DATA/Cut/image/Tr_{}.nii.gz'.format(str(idx)[:]))
        sitk.WriteImage(label_itk,
                            '/home/xsq/xsq/data_myself/GLIA-DATA/Cut/label/Tr_{}.nii.gz'.format(str(idx)[:]))
    print("Converted val IRCAD volumes to ROI")
...
def nifti_covert_h5(img_Dir, label_Dir):
    ...
    for case in img_path:  
        ...
        print('---------------')
        f = h5py.File(
                '/home/xsq/xsq/data_myself/GLIA-DATA/Cut/un-normalize/Tr_{}.h5'.format(str(idx)[:]), 'w')
...
def covert_h5_2(img_Dir, label_Dir):
    ...
    for case in img_path:  
        ...
        print("label shape", label.shape)
        f = h5py.File(
                '/home/xsq/xsq/data_myself/GLIA-DATA/dwh-H-h5/Tr_{}.h5'.format(str(idx)[:]), 'w')
...
if __name__ == '__main__':
    img_Dir = '/home/xsq/xsq/data_myself/GLIA-DATA/Cut/image/*.nii.gz'
    label_Dir = '/home/xsq/xsq/data_myself/GLIA-DATA/Cut/label/'
    #covert_h5_3(img_Dir, label_Dir)
    #covert_h5_2(img_Dir, label_Dir)
    #covert_nifti(img_Dir, label_Dir)
    nifti_covert_h5(img_Dir, label_Dir)
    #covert_nifti(img_Dir, label_Dir)
    #CT_nifti(img_Dir, label_Dir)
    #enhence(img_Dir, label_Dir)
    #cut(img_Dir, label_Dir)
